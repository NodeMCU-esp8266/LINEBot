...
const char* host =  "http://jawit-nodemcu.herokuapp.com/bot.php"; //PUT your Heroku App Name ex.http://mylinebot.herokuapp.com/bot.php
//NETPIE-Info
#define APPID       "SURASAKLINEBOT"                                //Same data at Line#3 of pub.php
#define KEY         "RP7ijqApYsXjRNhXmyG3KDTDv"                     //Same data at Line#4 of pub.php
#define SECRET      "JkdiSqkiB9BSRkJ:RP7ijqApYsXjRNhXmyG3KDTDv"     //Same data at Line#5 of pub.php
